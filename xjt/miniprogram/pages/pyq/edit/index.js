...
Page({
  data: {
    openid: undefined,
    adminOpenid: "o0L8g0WabpVHRvjgVVGAUjMlCnsA", //管理员openid
    textareaTxt: undefined,
    article: undefined,
    files: [],
    adminInfo: {
      avatarUrl: "cloud://apppgy-72vrx.6170-apppgy-72vrx-1301199205/pgy.jpg", //官方账号头像 
      nickName: "蒲公莹" //官方账号名称
    },
    userInfo: undefined,
    sendList: [{
  ...
  bindChangeUser(e) {
    ...
    if (e.currentTarget.dataset.index === 1) {
      this.setData({
        userInfo: {
          avatarUrl: "cloud://apppgy-72vrx.6170-apppgy-72vrx-1301199205/pgy.jpg",
          nickName: "蒲公莹"
        }
      })
    }
